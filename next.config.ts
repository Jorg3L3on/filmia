...
const nextConfig: NextConfig = {
  ...
  // those routes skip a blank loading.tsx flash. TMDB/OMDb use
  // unstable_cache (86400s) so metadata is not refetched on every ficha.
  // Mutations still revalidatePath.
  experimental: {
    staleTimes: {
      dynamic: 30,
    },

...
export default function EditListError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    console.error(error);
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 rounded-2xl border border-danger-line bg-danger-well px-6 py-16 text-center">
      ...
      <h1 className="font-serif text-3xl text-paper">No se pudo editar la lista</h1>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
        ...
        <Button href="/listas" variant="ghost">
          Volver a Listas
        </Button>
      </div>
    </div>

...
export default function PerfilError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    console.error(error);
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 rounded-2xl border border-danger-line bg-danger-well px-6 py-16 text-center">
      ...
      <h1 className="font-serif text-3xl text-paper">Perfil no cargó</h1>

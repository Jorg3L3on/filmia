...
export const AuthScreen = ({
  ...
  <div className="flex min-h-[100dvh] flex-col bg-[radial-gradient(ellipse_at_top,_rgba(124,156,255,0.22)_0%,_transparent_58%)] pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
